...
#define LG_HOST_REGISTRY(X) \
    ...
    X(PrefsSlider,    "dylv.liquidglass.prefsslider",  "PrefsSlider",     0.50f,          10.00f,    108.0f, 2.6f, 1.60f, 1.0f, 1.0f,  1.00f, "#FFFFFF1A", "#00000000") \
    X(PrefsSwitch,    "dylv.liquidglass.prefsswitch",  "PrefsSwitch",     0.50f,          5.000f,    108.0f, 2.6f, 1.60f, 1.0f, 1.0f,  1.00f, "#FFFFFF1A", "#00000000") \
